    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="custom-validation row g-3" method="POST" action="{{ route('artikel.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 col-md-8">
                        ...
                        <input type="file" name="image" id="image"
                            class="form-control @error('image') has-error @enderror" placeholder="image"
                            onchange="preview('.imageDemo', this.files[0])">
                        @error('image')
                        <p class="help-block text-danger">{{ $message }}</p>
                        @enderror
